...
const AppHeader = () => {
    ...
    return (
        <>
                        ...
                        <div className="flex justify-end items-center">
                            <nav className="page-header__bottom">
                                <ul className="flex justify-between items-center gap-x-6">
                                    ...
                                    <li>
                                        <div>
                                            <IoMdHeartEmpty className='icon-cart' />
                                        </div>
                                    </li>
                                    <li>
            ...
            <nav className="">
                <div className="container h-[45px] flex items-center">
                    <div className="basis-3/12 flex gap-x-1 px-1 items-center">
                        <GiHamburgerMenu />
                        <Dropdown menu={{ items }} placement="bottom" className="!px-1">
                            <Button className="!border-none !shadow-none font-bold uppercase">Danh mục sản phẩm</Button>
                        </Dropdown>
                    </div>
                    <ul className="basis-9/12 flex items-center">
                        <li>
                            <Link to="/" className='px-[12px] py-[8px] uppercase'>Trang chủ</Link>
                        </li>
                        <li>
                            <Link to="/" className='px-[12px] py-[8px] uppercase'>Giới Thiệu</Link>
                        </li>
                        <li>
                            <Link to="/" className='px-[12px] py-[8px] uppercase'>Sản Phẩm</Link>
                        </li>
                        <li>
                            <Link to="/" className='px-[12px] py-[8px] uppercase'>Tin Tức</Link>
                        </li>
                        <li>
                            <Link to="/" className='px-[12px] py-[8px] uppercase'>Liên Hệ</Link>
                        </li>
                    </ul>
                </div>
            </nav>
